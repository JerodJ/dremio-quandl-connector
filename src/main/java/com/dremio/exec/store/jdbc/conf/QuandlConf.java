...
@SourceType(value = "QuandlARP", label = "Quandl",uiConfig = "quandl-layout.json")
public class QuandlConf extends AbstractArpConf<QuandlConf> {
  private static final String ARP_FILENAME = "arp/implementation/quandl-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.quandl.QuandlDriver";
